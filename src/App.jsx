      ...
      axios.post('https://nidv-alidity-checker-backend-bangladesh.vercel.app/check_nid', data)
        .then(function (response) {
          ...
          if(response.data.isValid){
            toast.success('This NID Is Valid')
          }
          if(!response.data.isValid){
            toast.error('This NID Not Valid')
          }
          setLoading(false);
        })
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      ...
      <div className="mx-auto w-96 content-center px-3 lg:px-0">
        <div>
          ...
          <div className={isNID ? "block" : "hidden"}>
            <img onLoad={handleImageLoad} className="h-auto rounded-lg mb-5" src="https://i.ibb.co/Qf1GybZ/nidnum.png" alt="image description" />
          </div>

          <div className={isDOB ? "block" : "hidden"}>
            <img onLoad={handleImageLoad} className="h-auto rounded-lg mb-5" src="https://i.ibb.co/Q8TFsMp/dob.png" alt="image description" />
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <div className="flex">
                ...
                <input onBlur={handleBlur} required onFocus={handleNIDnumCard} type="text" name="nid_number" className="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="XXXXXXXXXX" />
              </div>
            </div>
            <div className="mb-6">
      ...
      <footer className="fixed bottom-0 left-0 z-20 w-full p-4 bg-white border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
        <span className="mx-auto text-sm text-gray-500 text-center dark:text-gray-400">© Copyright 2023. Developed By <a href="https://nabilnewaz.com/" className="hover:underline">Nabil Newaz</a>
        </span>
      </footer>
